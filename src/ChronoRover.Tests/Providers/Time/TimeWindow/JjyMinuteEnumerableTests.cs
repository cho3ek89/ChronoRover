...
[TestFixture]
public class JjyMinuteEnumerableTests
{
    [Test]
    ...
    public void GetEnumeratorReturnsCorrectValues(DateTime utcDateTime, DateTime[] expectedDateTimes)
    {
        ...
        var minuteEnumerable = new JjyMinuteEnumerable(timeProvider, timeZoneProvider);
