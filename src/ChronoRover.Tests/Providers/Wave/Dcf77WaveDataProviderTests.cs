...
[TestFixture]
public class Dcf77WaveDataProviderTests
{
    [Test]
    ...
    public void WaveDataIsCorrectForSecond(int second, bool[] signalBits, string expectedSamplesFileName)
    {
        ...
        var provider = new Dcf77WaveDataProvider(
    ...
    {
        var filePath = Path.Combine("TestData", "Wave", "Providers", "Dcf77WaveDataProviderTests", fileName);
    ...
    private static object[] GetWaveDataIsCorrectForSecondTestData()
    {
        ...
        static bool IsMarkerSecond(int second) => second is 59;
    }
