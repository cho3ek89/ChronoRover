...
[TestFixture]
public class JjyWaveDataProviderTests
{
    [Test]
    ...
    public void WaveDataIsCorrectForSecond(int second, bool[] signalBits, string expectedSamplesFileName)
    {
        ...
        var provider = new JjyWaveDataProvider(
    ...
    {
        var filePath = Path.Combine("TestData", "Wave", "Providers", "JjyWaveDataProviderTests", fileName);
